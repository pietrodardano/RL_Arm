"""
UR5e robot arm environment implementation.

This module implements the RL environment for the Universal Robots UR5e manipulator.
"""
...
class UR5eEnv(ManagerBasedRLEnv):
    """
    ...
    tasks using the UR5e robot arm. Tasks can be customized by modifying
    the configuration and reward functions.
    """

    cfg: UR5eEnvCfg

    def __init__(self, cfg: UR5eEnvCfg, render_mode: str | None = None, **kwargs):
        """
        Initialize the UR5e environment.
    ...
    def _setup_scene(self):
        """Setup the scene for the UR5e environment."""
