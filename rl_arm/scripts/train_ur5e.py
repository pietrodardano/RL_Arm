"""
Example training script for UR5e environment.

This script demonstrates how to train an RL agent on the UR5e manipulation task.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train RL agent on UR5e environment")
    
    # Environment arguments
    parser.add_argument("--task", type=str, default="UR5e-Reach", help="Name of the task")
    ...
    parser.add_argument("--experiment_name", type=str, default="ur5e_reach", help="Experiment name")
